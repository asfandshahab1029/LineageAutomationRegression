...
public class EnergyPage {
    ...
    By SpaceEfficiency = By.xpath("//div[2]/div/div/div/div/label[1]/input");
    By ThroughputEfficiency = By.xpath("//div[2]/div/div/div/div/label[2]/input");
    By ThroughputEnergyCost = By.xpath("//div[2]/div/div/div/div/label[3]/input");
    By RevenueEfficiency = By.xpath("//div[2]/div/div/div/div/label[4]/input");
    ...
    By CurrentYearSpaceEfficiency = By.xpath("//div/div[2]/div[2]/div[2]/div/div/div[1]/div[2]/div/div[2]/div[2]/label[1]/input");
    By PreviousYearSpaceEfficiency = By.xpath("//div/div[2]/div[2]/div[2]/div/div/div[1]/div[2]/div/div[2]/div[2]/label[2]/input");
    By VarianceYOY = By.xpath("//div/div[2]/div[2]/div[2]/div/div/div[1]/div[2]/div/div[2]/div[2]/label[3]/input");
    //Table Settings
    ...
    public void SelectSpaceEfficiency() {
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        driver.findElement(By.xpath("//div/div[2]/div[1]/div/div[1]/div/button")).click();
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        driver.findElement(SpaceEfficiency).click();
    }

    public void SelectVThroughputEfficiency() {
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        driver.findElement(By.xpath("//div/div[2]/div[1]/div/div[1]/div/button")).click();
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        driver.findElement(ThroughputEfficiency).click();
    }

    public void SelectThroughputEnergyCost() {
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        driver.findElement(By.xpath("//div/div[2]/div[1]/div/div[1]/div/button")).click();
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        driver.findElement(ThroughputEnergyCost).click();
    }

    public void SelectRevenueEfficiency() {
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        driver.findElement(By.xpath("//div/div[2]/div[1]/div/div[1]/div/button")).click();
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        driver.findElement(RevenueEfficiency).click();
    ...
    public void SelectCurrentYearSpaceEfficiency() {
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        driver.findElement(CurrentYearSpaceEfficiency).click();
    }

    public void SelectPreviousYearMovingAvg() {
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        driver.findElement(PreviousYearSpaceEfficiency).click();
    }

    public void SelectVarianceYOY() {
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        driver.findElement(VarianceYOY).click();
    }
    //Table Settings
